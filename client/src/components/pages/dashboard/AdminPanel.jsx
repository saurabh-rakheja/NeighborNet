...
const AdminPanel = () => {
  ...
  const activityTypes = ['All', 'User Verification', 'Event Approval', 'User Registration', 'Event Rejection'];
  ...
  return (
    <div className="max-w-7xl mx-auto">
      <div className="mb-8">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-6 mb-8">
            ...
            <div className="flex items-center">
              ...
              <div>
                ...
                <div className="flex items-center text-sm">
                  <span className="text-gray-500">Volunteers: {stats.totalVolunteers}</span>
          ...
          <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-6">
            <div className="flex items-center">
              ...
              <div>
                ...
                <div className="flex items-center text-sm">
                  <span className="text-red-500">Pending: {stats.pendingEvents}</span>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-6">
            <div className="flex items-center">
              ...
              <div>
                ...
                <div className="flex items-center text-sm">
                  <Link to="/dashboard/admin/verification" className="text-indigo-600 hover:text-indigo-800">
                    View all
                  </Link>
                </div>
              </div>
          ...
          <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-6">
            <div className="flex items-center">
              ...
              <div>
                <p className="text-sm text-gray-500 font-medium">Volunteer Hours</p>
                <p className="text-2xl font-bold text-gray-800">{stats.totalHours.toLocaleString()}</p>
                <div className="flex items-center text-sm">
                  <Link to="/dashboard/admin/reports" className="text-indigo-600 hover:text-indigo-800">
                    View reports
                  </Link>
                </div>
              </div>
                    ...
                    <tr key={verification.id} className="hover:bg-gray-50">
                      ...
                      <td className="px-6 py-4 whitespace-nowrap">
                        <span className={`inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium ${
                          verification.type === 'NGO' ? 'bg-blue-100 text-blue-800' : 'bg-green-100 text-green-800'
                        }`}>
                          {verification.type}
                        </span>
                      </td>
        ...
        <div className="bg-white rounded-xl shadow-sm border border-gray-100 mb-8">
          <div className="flex items-center justify-between p-6 border-b border-gray-100">
            <h2 className="text-lg font-bold text-gray-800">Events Awaiting Approval</h2>
            <Link
                      ...
                      <tr key={activity.id} className="hover:bg-gray-50">
                        <td className="px-6 py-4">
                          <div className="flex items-start">
                            <span className={`inline-flex mr-3 mt-0.5 items-center px-2.5 py-0.5 rounded-full text-xs font-medium ${
                              activity.type === 'User Verification' ? 'bg-green-100 text-green-800' :
                              activity.type === 'Event Approval' ? 'bg-blue-100 text-blue-800' :
                              activity.type === 'Event Rejection' ? 'bg-red-100 text-red-800' :
